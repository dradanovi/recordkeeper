...
public class WorkHoursService {
	...
	public List<WorkHoursDto> test() {
		FilerHoursRequest req = new FilerHoursRequest("Jun 21 2020", "Jun 22 2020");
		List<Object[]> list = hoursRepo.workHours(dateService.stringToLDT(req.getStart(), true),
				dateService.stringToLDT(req.getEnd(), false), "pero");
		...
		// 2020-06-20 20:31:32.0
//				DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
//				String startd = hours[1].toString();
//				startd = startd.substring(0, 19);
//				System.out.println("start string " + startd);
//				
//				String endd = hours[2].toString();
//				endd = startd.substring(0, 19);
//				System.out.println("end string " + startd);
//				
//				Long user_id = Long.parseLong(hours[3].toString());
//				
//				WorkHours hourz = new WorkHours(Long.parseLong(hours[0].toString()), LocalDateTime.parse(startd, formatter), LocalDateTime.parse(endd, formatter), userRepo.findById(user_id).get());
//				System.out.println("model hours " + hourz.toString());
	}
